...
#'
#' @description
#' \code{PlotPSI.MXE} visualizes percent spliced-in (PSI) for each genomic coordinate for mutually exclusive exons (MXE) event across two groups of single cells.
#'
#' @details
...
#' PlotPSI.MXE.TwoGroups(PSI, SampleInfo=system.file("extdata/Sample_Info",
...
PlotPSI.MXE.TwoGroups <- function(object, SampleInfo, ExonInfo, statistical.test=c("wilcox", "t.test"), multiple.testing=c("holm", "hochberg", "hommel", "bonferroni", "BH", "BY", "fdr", "none"), Plots, plot.width, plot.height) {
